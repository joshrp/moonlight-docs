...
6. Check the list of known application compatibility issues above.
...
5. [Send us an email](https://github.com/moonlight-stream/moonlight-docs/wiki/Get-In-Touch)
...
3. Ensure none of the known incompatible software above is installed on your PC.
